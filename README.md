[![Perl Tests](https://github.com/ElMikosch/spoton/actions/workflows/perl-tests.yml/badge.svg)](https://github.com/ElMikosch/spoton/actions/workflows/perl-tests.yml)
...
2. Add the repository URL:
   ```
   https://raw.githubusercontent.com/ElMikosch/spoton/main/repo.xml
   ```
